...
class UIFactory:
    ...
    def get_ui_and_action(self, button_id: str):
        """Maps button ID to UI class and action function."""
        if button_id == "load-session":
            ...
            raise ValueError(f"Unknown button ID: {button_id}. Make sure the ID is mapped in 'get_ui_and_action'.")
